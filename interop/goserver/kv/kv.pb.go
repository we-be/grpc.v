...
func (x *PutManyResponse) GetWritten() int32 {
	if x != nil {
		return x.Written
	}
	return 0
...
const file_kv_proto_rawDesc = "" +
	...
	"\x0fPutManyResponse\x12\x18\n" +
	"\awritten\x18\x01 \x01(\x05R\awritten2\xb1\x01\n" +
	"\x02KV\x12&\n" +
	"\x03Get\x12\x0e.kv.GetRequest\x1a\x0f.kv.GetResponse\x12&\n" +
	"\x03Put\x12\x0e.kv.PutRequest\x1a\x0f.kv.PutResponse\x12)\n" +
	"\x04Scan\x12\x0e.kv.GetRequest\x1a\x0f.kv.GetResponse0\x01\x120\n" +
	"\aPutMany\x12\x0e.kv.PutRequest\x1a\x13.kv.PutManyResponse(\x01B\x19Z\x17example.com/kvserver/kvb\x06proto3"
...
var file_kv_proto_goTypes = []any{
	...
	(*PutManyResponse)(nil), // 4: kv.PutManyResponse
}
var file_kv_proto_depIdxs = []int32{
	...
	2, // 3: kv.KV.PutMany:input_type -> kv.PutRequest
	1, // 4: kv.KV.Get:output_type -> kv.GetResponse
	3, // 5: kv.KV.Put:output_type -> kv.PutResponse
	1, // 6: kv.KV.Scan:output_type -> kv.GetResponse
	4, // 7: kv.KV.PutMany:output_type -> kv.PutManyResponse
